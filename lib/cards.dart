            ...
            children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              TextButton(
                                ...
                                child: const Text(
                                  "SHARE",
                                  style:
                                      TextStyle(color: MyColorsSample.accent),
                                ),
                                onPressed: () {},
                              ),
                              TextButton(
              ...
              Card(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Image.asset(
                      ImgSample.get('maintenance_mode.png'),
                      height: 250,
                      width: double.infinity,
                      fit: BoxFit.cover,
                    ),
                ...
                child: Padding(
                  ...
                  child: Card(
                    ...
                    child: Stack(
                      fit: StackFit.expand,
                      children: <Widget>[
                        Image.asset(ImgSample.get('world_map.png'),
                            fit: BoxFit.cover),
                        Container(
                          margin: const EdgeInsets.all(20),
                          alignment: Alignment.bottomRight,
                          child: Image.asset(
                              ImgSample.get("ic_copper_card.png"),
                              width: 60,
                              height: 60),
                        ),
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  const Spacer(),
                                  Image.asset(ImgSample.get("ic_visa.png"),
                                      color: Colors.white,
                                      fit: BoxFit.cover,
                                      width: 60,
                                      height: 30),
